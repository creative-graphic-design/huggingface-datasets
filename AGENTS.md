...
- Keep dataset README notes concise and limited to user-facing facts needed for correct loading or interpretation. Avoid long investigative logs, repeated command histories, or implementation rationale in README files; put that detail in PR discussion instead.
